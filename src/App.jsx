									...
									<div className="card-body">
										...
										<div className="form-group row">
											...
											<div className="col-sm-10">
												<input type="text" className="form-control" id="name" name="name" placeholder="Enter your full name" autoFocus="" required=""></input>
										...
										<div className="form-group row">
											...
											<div className="col-sm-10">
												<input type="email" className="form-control" id="email" name="email" placeholder="Enter your email address" required=""></input>
										...
										<div className="form-group row">
											...
											<div className="col-sm-10">
												<input type="text" className="form-control" id="phone" name="phone" placeholder="Enter your phone number" required=""></input>
										...
										<div className="form-group row">
											...
											<div className="col-sm-10">
												<input type="date" className="form-control" id="dob" name="dob" placeholder="Enter your Date of Birth" required=""></input>
											...
											<div className="col-sm-10">
												<div className="form-check form-check-inline">
													<label className="form-check-label mb-small" htmlFor="male">Male
														<input className="form-check-input" type="radio" name="gender" id="male" value="male" required=""></input>
														<span className="checkmark"></span>
													</label>
												</div>
												<div className="form-check form-check-inline">
													<label className="form-check-label mb-small" htmlFor="female">Female
														<input className="form-check-input" type="radio" name="gender" id="female" value="female" required=""></input>
														<span className="checkmark"></span>
													</label>
												</div>
												<div className="form-check form-check-inline">
													...
													<label className="form-check-label mb-small" htmlFor="other">Other
														<input className="form-check-input" type="radio" name="gender" id="other" value="other" required=""></input>
														<span className="checkmark"></span>
													</label>
												</div>
											</div>
											...
											<div className="col-sm-10 row">
												<div className="col-sm-6">
													<div className="custom-file">
														<input type="file" className="custom-file-input" id="aadharFront" name="aadharFront" required=""></input>
												...
												<div className="col-sm-6">
													<div className="custom-file">
														<input type="file" className="custom-file-input" id="aadharBack" name="aadharBack" required=""></input>
								...
								<div className="card">
									...
									<div className="card-body">
										...
										<div className="form-group row">
											...
											<div className="col-sm-10">
												<input type="text" className="form-control" id="fname" name="fname" placeholder="Enter your parent / guardian / spouse name" required=""></input>
										...
										<div className="form-group row">
											...
											<div className="col-sm-10">
												<input type="text" className="form-control" id="fphone" name="fphone" placeholder="Enter your parent / guardian / spouse phone number" required=""></input>
										...
										<div className="form-group row">
											<div className="offset-sm-2 col-sm-10">
												<div className="form-check form-check-inline">
													<label className="
													">
														<input type="checkbox" id="same" value="same"></input>
														<span className="slider round"></span>
													</label>
													<label className="form-check-label pr-2 text-muted" htmlFor="same">Same as Permanent Address</label>
													<input className="form-check-input" type="checkbox" id="same" value="same"></input>
													<span className="checkmark"></span>
											...
											<div className="col-sm-10">
												<div className="form-check form-check-inline">
													<label className="form-check-label mb-small" htmlFor="student">Student
														<input className="form-check-input" type="radio" name="areyoua" id="student" value="student" required=""></input>
														<span className="checkmark"></span>
													</label>
												</div>
												<div className="form-check form-check-inline">
													<label className="form-check-label mb-small" htmlFor="working">Working Professional
														<input className="form-check-input" type="radio" name="areyoua" id="working" value="working" required=""></input>
														<span className="checkmark"></span>
													</label>
												</div>
											</div>
										...
										<div className="areyoua-div">
											<div className="student-div">
												<div className="form-group row">
													...
													<div className="col-sm-10">
														<input className="form-control" type="text" name="qualification" id="qualification" placeholder="Your latest educational degree / diploma" required=""></input>
													</div>
												</div>
												...
												<div className="form-group row">
													...
													<div className="col-sm-10">
														<input className="form-control" type="text" name="qualificationYear" id="qualificationYear" placeholder="Completion Year" required=""></input>
												...
												<div className="form-group row">
													...
													<div className="col-sm-10">
														<input className="form-control" type="text" name="college" id="college" placeholder="College / University" required=""></input>
													</div>
												</div>
											</div>
										</div>
									...
									<div className="card-body">
										...
										<div className="form-group row">
											...
											<div className="col-sm-10 course-div">
												<select defaultValue="Course you opted for" className="custom-select" name="course" id="course" required="">
											...
											<div className="col-sm-10 source">
												<div className="form-check form-check-inline">
													<label className="form-check-label mb-small" htmlFor="google">Google
														<input className="form-check-input" type="radio" name="referral" id="google" value="google" required=""></input>
														<span className="checkmark"></span>
													</label>
												</div>
												<div className="form-check form-check-inline">
													<label className="form-check-label mb-small" htmlFor="facebook">Facebook
														<input className="form-check-input" type="radio" name="referral" id="facebook" value="facebook" required=""></input>
														<span className="checkmark"></span>
													</label>
												</div>
												<div className="form-check form-check-inline">
													<label className="form-check-label mb-small" htmlFor="instagram">Instagram
														<input className="form-check-input" type="radio" name="referral" id="instagram" value="instagram" required=""></input>
														<span className="checkmark"></span>
													</label>
												</div>
												<div className="form-check form-check-inline">
													<label className="form-check-label mb-small" htmlFor="collegetpo">College TPO
														<input className="form-check-input" type="radio" name="referral" id="collegetpo" value="collegetpo" required=""></input>
														<span className="checkmark"></span>
													</label>
												</div>
												<div className="form-check form-check-inline">
													<label className="form-check-label mb-small" htmlFor="friend">Friend
														<input className="form-check-input" type="radio" name="referral" id="friend" value="friend" required=""></input>
														<span className="checkmark"></span>
													</label>
												</div>
								...
								<div className="col-sm-12 tnc">
									<div className="form-check form-check-inline">
										<label className="switch">
											...
											<span className="slider round" onClick="alert('Open Terms &amp; Conditions and click on I Agree.')"></span>
										</label>
										...
										<input className="form-check-input" type="checkbox" id="terms" value="terms" required></input>
										<span className="checkmark"></span>

									</div>
								</div>
								<div className="col-sm-12">
									<input type="submit" name="register" className="btn btn-lg btn-primary btn-block" value="Register"></input>
								</div>
